...
def stroom_verbruik_woning(uur):
    """
...
if __name__ == "__main__":
    ...
    verbruik = [stroom_verbruik_woning(u) for u in uren]
    
    # Print wat voorbeelden
    print(f"Verbruik 03:00 (Nacht)  : {stroom_verbruik_woning(3.0):.2f} kW")
    print(f"Verbruik 07:30 (Ochtend): {stroom_verbruik_woning(7.5):.2f} kW")
    print(f"Verbruik 19:30 (Avond)  : {stroom_verbruik_woning(19.5):.2f} kW")
